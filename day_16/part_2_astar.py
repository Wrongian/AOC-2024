...
parents = {}
end_found = False
heappush(heap, (heuristic(start), 0, count, start, 1, 0, 0))
"""heuristic is manhantten distance to end"""
visited = set()
while heap:
  f, score, _, pos, dir, p, pdir = heappop(heap)
  ...
  for rotate in rotations:
    ...
    heappush(heap, (score + 1000 + heuristic(npos),
             score + 1000, count, npos, ndir, pos, dir))
  ...
  count += 1
  heappush(heap, (score + 1000 + heuristic(npos),
           score + 1, count, npos, ndir, pos, dir))
